 ...
 */
function detectTechStack(extensions: string[], paths: string[]): string[] {
  ...
  for (const ext of extensions) {
    if (langMap[ext]) stack.add(langMap[ext]);
  }
  ...
  if (pathStr.includes('next')) {
    stack.add('Next.js');
    if (pathStr.includes('app/')) stack.add('App Router');
    if (pathStr.includes('pages/')) stack.add('Pages Router');
  }
  if (pathStr.includes('react')) stack.add('React');
  if (pathStr.includes('vue')) stack.add('Vue');
  if (pathStr.includes('src/components')) stack.add('Component-based');
  if (pathStr.includes('prisma')) stack.add('Prisma ORM');
  if (pathStr.includes('drizzle')) stack.add('Drizzle ORM');
  if (pathStr.includes('supabase')) stack.add('Supabase');
  if (pathStr.includes('tailwind')) stack.add('Tailwind CSS');
  if (pathStr.includes('shadcn')) stack.add('shadcn/ui');
  if (pathStr.includes('api/')) stack.add('API Routes');
  if (pathStr.includes('server/')) stack.add('Server-side');
  if (pathStr.includes('lib/')) stack.add('Library code');
 ...
 */
function parseFileComments(text: string): FileComment[] {
